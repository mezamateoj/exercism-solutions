...
class Mascota {
    ...
    // Tu código aca:
    return Object.values(this.dueño).reverse().join(' ');
    }
    ...
    // this.actividades['frecuencia'] = frecuencia;
    }
    ...
    // Tu código aca:
        return this.actividades.find(item => item.actividad)['frecuencia'];
    }
}

  
const test = new Mascota('cachito', {apellido: 'meza', nombre: 'mateo'}, [{actividad: 'salir a caminar', frecuencia: '1 vez al dia'}]);
// console.log(test);
// test.addActividad('salir', '2 veces al dia');
// console.log(test.getActividades());
// console.log(test.getDueño());
// console.log(test.getFrecuencia('salir'))
